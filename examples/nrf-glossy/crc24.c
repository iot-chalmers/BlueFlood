...
//hack because the code does not fit on BLE nano!

// unsigned short
// crc16_add_(unsigned char b, unsigned short acc)
// {
//   /*
...
// /*---------------------------------------------------------------------------*/
// unsigned short
// crc16_data_(const unsigned char *data, int len, unsigned short acc)
// {
//   int i;
...
// uint32_t crc24_calc(uint8_t *cp, unsigned int len) {
// 	uint32_t crc = crc16_data_(cp, len, 0x5555U);
//  	return crc | ((crc<<8U)&0xff);
// }
