...
<simconf>
  ...
  <simulation>
    ...
    <randomseed>1445516645054</randomseed>
    ...
    <motetype>
      ...
      <description>3pc</description>
      <firmware EXPORT="copy">[CONTIKI_DIR]/apps/chaos/3pc/3pc-app.cooja06.sky</firmware>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>12.120024790345301</x>
        <y>14.303892119157162</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>32.36439491503168</x>
        <y>9.237961036036415</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>57.21590645041439</x>
        <y>15.63205870613709</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>66.07306777285457</x>
        <y>36.40093900292289</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>53.640624390793775</x>
        <y>54.83142418625409</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>34.774472402628746</x>
        <y>70.89308668682563</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        org.contikios.cooja.mspmote.interfaces.MspClock
    ...
    <mote>
      ...
      <interface_config>
        org.contikios.cooja.interfaces.Position
        <x>29.221962160985356</x>
        <y>34.343588037222986</y>
        <z>0.0</z>
      </interface_config>
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>1.8703132452010918 0.0 0.0 1.8703132452010918 -18.122788352093853 -10.935079953954824</viewport>
    </plugin_config>
    <width>123</width>
    <z>2</z>
    <height>183</height>
